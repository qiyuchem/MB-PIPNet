...
module NN_class
    ...
    integer :: Natm, Nmol, Ninput1b, Ninput2b, Ninput3b, Ninput4b
    ...
    real,dimension(:),allocatable :: scale0,scale1
    real:: ymax,ymin,scale2
  ...
  subroutine FFNN_init()
    ...
    allocate(scale0(Ninput),scale1(Ninput))
  ...
  subroutine init_wt_bias(lower, upper, flag, filewt)
    ...
    if(flag==1) then
      ...
      do i=1,Ninput
      scale0(i)=2.d0/(xmax(i)-xmin(i))
      scale1(i)=-1.0-2.d0*xmin(i)/(xmax(i)-xmin(i))
      end do
